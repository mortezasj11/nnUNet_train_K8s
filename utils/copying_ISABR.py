...
path_ct = '/Data7/mbsaad/Datasets/SABR/ISABR/Final/CT'
path_rts = '/Data7/mbsaad/Datasets/SABR/ISABR/Final/SEG'
...
if __name__ == '__main__':
    for idx, ct_file in enumerate(os.listdir(path_ct)):
        try:
            ...
            path_rts_src = os.path.join(path_rts, f'RTS_{ct_id}.nii.gz')
            ...
            path_ct_des = os.path.join(path_des_im_tr, f'{ct_id}_ISABR_0000.nii.gz')
            path_seg_des = os.path.join(path_des_lb_tr, f'{ct_id}_ISABR.nii.gz')
